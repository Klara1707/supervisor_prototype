    ...
    const contentMap = {
        leadership1: {
            ...
            cells: [
                ...
                { type: "textWithCheckbox", text: "Proficient in using RTIO Leadership Coaching (PowerApps) to record all LIF interactions", checkboxLabel: "Box 1" },
                { type: "textWithCheckbox", text: "Skilled in completing LIF interaction forms with detailed input, including clear descriptions of WWW (What Went Well) and EBI (Even Better If), along with thoughtful reflection", checkboxLabel: "Box 2" },
                ...
                { type: "textWithCheckbox", text: "Facilitates effective PSI meetings, ensuring clear communication, engagement, and follow-up on safety and operational actions", checkboxLabel: "Box 3" },
                { type: "textWithCheckbox", text: "Can facilitate a PSI by following the PSI board cadence and effectively leading discussions on daily hazards and controls", checkboxLabel: "Box 4" },
                { type: "textWithCheckbox", text: "Can facilitate a PSI by following the PSI board cadence and effectively leading discussions on daily hazards and controls", checkboxLabel: "Box 5" },
                ...
                "Sign off", "comment section",
                { type: "textWithCheckbox", text: "Leads effective meetings and communications across all LIF activities (CRM, PTHA, QSI, SPOTLIGHT)", checkboxLabel: "Box 6" },
                { type: "textWithCheckbox", text: "Understands each activity’s purpose, the LIF playback intent, and communicates their LIF involvement clearly in meetings", checkboxLabel: "Box 7" },
                { type: "textWithCheckbox", text: "Provides effective, positive coaching and feedback during interactions, and confirms controls are in place", checkboxLabel: "Box 8" },
                { type: "textWithCheckbox", text: "Can give coaching and feedback in the interaction effectively and positively. Uses - QSI methods and techniques effectively. ", checkboxLabel: "Box 9" },
                ...
                "Sign off", "comment section",
                { type: "textWithCheckbox", text: "Competent in accessing and updating Check-Ins through the relevant platform Able to view and edit personal P6 Objectives to reflect current goals and development focus", checkboxLabel: "Box 10" },
                { type: "textWithCheckbox", text: "needs checking", checkboxLabel: "Box 11" },
                { type: "textWithCheckbox", text: "Demonstrates the ability to accurately enter objectives and understands the various types and their intended outcomes. Proactively follows up on assigned actions and ensures they are fully completed and closed out.", checkboxLabel: "Box 12" },
                ...
                "Sign off", "comment section",
                { type: "textWithCheckbox", text: "Demonstrates competence in accessing, creating, and editing their Development Plan using the designated platform", checkboxLabel: "Box 13" },
                { type: "textWithCheckbox", text: "Effectively navigates the designated platform to access, create, and update their Development Plan with confidence and accuracy", checkboxLabel: "Box 14" },
                { type: "textWithCheckbox", text: "Takes ownership of personal development by actively driving progress, following up on assigned actions, reporting updates during check-ins, and ensuring objectives are completed ahead of their due dates", checkboxLabel: "Box 15" },
        ...
        leadership2: {
            ...
            cells: [
                "Skills/Responsibilities", "Sub Section 1", "Sub Section 2", "Sub Section 3",
                "Training Process", "Training Material", "Reviewer sign off", "Comments",
                { type: "textWithCheckbox", text: "Builds effective relationships with site stakeholders and actively participates in key meetings (e.g., PMO, MTS, SusCap)", checkboxLabel: "Box 1" },
                { type: "textWithCheckbox", text: "Takes ownership of in-pit programs by building key contacts, presenting drilling designs, negotiating pit windows with MTS and Production, and aligning with the 2-week plan", checkboxLabel: "Box 2" },
                { type: "textWithCheckbox", text: "Can assess the D+B plod, negotiate access with MTS and D+B Supervisor, and review the monthly production plan to forecast pit windows", checkboxLabel: "Box 3" },
                { type: "textWithCheckbox", text: "Fully familiar with all Mine Operations stakeholders; able to present drilling plans and negotiate pit windows months in advance", checkboxLabel: "Box 4" },
                ...
                "Sign off", "comment section",
                { type: "textWithCheckbox", text: "Identifies and supports department recognition initiatives, such as Rockstar", checkboxLabel: "Box 5" },
                { type: "textWithCheckbox", text: "Identifies potential Rockstar nominees using the Rockstar website, provides detailed justification to the approver, and supports recognition with evidence of achievements", checkboxLabel: "Box 6" },
        ...
        leadership3: {
            ...
            cells: [
                "Skills/Responsibilities", "Sub Section 1", "Sub Section 2", "Sub Section 3",
                "Training Process", "Training Material", "Reviewer sign off", "Comments",
                { type: "textWithCheckbox", text: "Provides LIF coaching to Contract Partner Supervisors to support quality safety interactions", checkboxLabel: "Box 1" },
                { type: "textWithCheckbox", text: "Schedules LIF coaching in meetings, delivers coaching aligned with QSI and LIF training guidelines, and encourages Contract Partners to use LIF prompts when recounting daily activities", checkboxLabel: "Box 2" },
                { type: "textWithCheckbox", text: "Follows up on coaching EBI and actions, maintaining vigilance over the quality of LIF interactions", checkboxLabel: "Box 3" },
                ...
                "Sign off", "comment section",
                { type: "textWithCheckbox", text: "Facilitates effective LiF meetings, ensuring clear communication, issue tracking, and action follow-up", checkboxLabel: "Box 4" },
                { type: "textWithCheckbox", text: "Full understanding of all DDM/LiF meeting sections. Actively covers each area, drives discussion, takes actions, and follows up on progress", checkboxLabel: "Box 5" },
                ...
                "Sign off", "comment section",
                { type: "textWithCheckbox", text: "Coach and support other Supervisors within your SME area", checkboxLabel: "Box 6" },
                { type: "textWithCheckbox", text: "Earthworks: Mentor other Supervisors on operating conditions and methods. Field Supervisor: Share SME experience and mentor others in high-risk work. Hydro: Mentor others in CMS processes. RC/Diamond: Mentor others in CMS processes", checkboxLabel: "Box 7" },
                ...
                "Sign off", "comment section",
                { type: "textWithCheckbox", text: "Participate in developing productivity improvements through observation, feedback, and process enhancement", checkboxLabel: "Box 8" },
                { type: "textWithCheckbox", text: "Identify improvement opportunities within your work scope and systems used", checkboxLabel: "Box 9" },
                { type: "textWithCheckbox", text: "Assess data to identify improvement opportunities and implement actions to drive results", checkboxLabel: "Box 10" },
