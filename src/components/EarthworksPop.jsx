...
const LevelPopup = ({ level, onClose, popupId, userToken, onProgressUpdate }) => {
            ...
            const boxTextsByLevel = {
                1: [
                    ["Maintain accurate Daily Log and Pad Tracking Sheets", 
                        "Understands the importance of accurate data entry and ensures error-free reporting", 
                        "Extracts data from sheets accurately for effective reporting", 
                        "", 
                        ...
                        "DataEntery"],
                    ["Understands pad and track construction guidelines, including approved designs", 
                        "Understands Earthworks guidelines for pad and track creation. Applies construction methods in the field, verifies compliance, and differentiates pad sizes", 
                        "Provides accurate guidance on pad and track construction in the field, demonstrating a strong understanding of clearance mechanisms and the implications of non-compliance with established guidelines", 
                        "", 
                        ...
                        "PadDimensions"],
                    ["Demonstrates an understanding of rehabilitation operations, including the verification of completed work to ensure compliance with environmental and operational standards", 
                        "Has read the Earthworks Rehabilitation Manual and is able to apply rehabilitation methods effectively in the field. Verifies that procedures are being followed in accordance with the guidelines", 
                        "Provides accurate guidance on rehabilitation activities in the field, with a solid understanding of clearance mechanisms and the consequences of non-compliance with established guidelines", 
                        "Verifies that rehabilitation is being conducted in accordance with established guidelines, including performing 10% pad verification checks, capturing photographic evidence, and reporting findings to ensure compliance",
                ...
                2: [
                    ["Understands the ResDev Rehabilitation Standard and its application in field activities", 
                        "Reads and understands the Operations Rehabilitation Manual", 
                        "Understands rehabilitation obligations and standards, including relevant guidelines and expectations", 
                        "", 
                    ...
                    ["Competent in requesting and managing HME float movements, understanding the process and stakeholder coordination involved", 
                        "Communicates with float driver/company, completes float requests accurately with pickup/drop-off maps, and assesses site suitability for safe turnaround and travel", 
                        "", 
                        "", 
                        "Exposure – Mentored by SME on completing float requests, reviewing maps, and assessing safe drop-off points", 
                        ""],
                    ["Manages pad and track construction according to approved designs and guidelines, ensuring clearing limits are adhered to within the designated work area", 
                        "Assesses pad size and clearance against standards (10% RTIO, 100% Cat 3) and reports any non-compliance with clearing rules", 
                        "Tracks clearing allocations in ARs, engages DPC to confirm clearing levels, and monitors progress until pad construction is complete", 
                        "", 
                        ...
                        "GroundDisturbanceBI"],
                    ["Competent in operating the Trimble SNS machine guidance system, including uploading data to HME and using all system functionalities", 
                        "Loads files onto USBs and Gen 3 screens, troubleshoots issues, and provides guidance on system usage", 
                        "Uses user guides to perform firmware updates confidently and accurately", 
                        "", 
                        ...
                        ""],
                    ["Understands when and how to engage the Survey Team and DPC, using the correct request formats and communication channels", 
                        "Understands when and how to engage the Survey Team and DPC, using the correct request formats and communication channels", 
                        "Understands when survey work is required and what it involves — including pad set-out, pad and collar pickups, and boundary flagging", 
                        "", 
                ...
                3: [
                    ["Understand earthwork machinery capabilities and limitations. Plan and manage tasks using SME knowledge", 
                        "Provide guidance on machine allocation and assess ground conditions to inform planning", 
                        "Instruct operators on pad and track building methods. Use machinery effectively to achieve optimal results", 
                        "", 
